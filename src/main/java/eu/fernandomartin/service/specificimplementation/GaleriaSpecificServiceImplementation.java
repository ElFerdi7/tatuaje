 ...
 * @author Fernando
 */
public class GaleriaSpecificServiceImplementation extends TableGenericServiceImplementation {

    public GaleriaSpecificServiceImplementation(HttpServletRequest request) {
        super(request);
    }
